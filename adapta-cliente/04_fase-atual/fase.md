...
| F1-T10 | 6 | Exercitar permissões, auditoria e dados incompletos do painel | Matheus Silva | SPEC-1-002 | acesso negado, lead incompleto e painel indisponível são recuperáveis | Cenários; RN-3–RN-5 | log de acesso, pendência e sem vazamento | F1-T06 | parar em alteração indevida ou cartão falso | CONCLUÍDA |
| F1-T11 | 6 | Exercitar bloqueios de catálogo, mídia e envio duplicado | Matheus Silva | SPEC-1-003 | inativo, incompleto, divergente, URL insegura e retry bloqueiam corretamente | Cenários; RN-1–RN-5 | relatório e logs de bloqueio | F1-T07 | parar se dado não confirmado for enviado | CONCLUÍDA 2026-09-07 |
